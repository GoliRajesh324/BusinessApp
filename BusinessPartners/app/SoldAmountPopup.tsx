...
type CropDetails = { id: string; businessId: string; [key: string]: any };

interface SoldAmountPopupProps {
  visible: boolean;
  partners: Partner[];
    ...
    <Modal visible={visible} animationType="slide" transparent>
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Add Sold Amount</Text>
...
// ---------- Reuse same styles as AddInvestmentPopup ----------
