...
const resources = {
  ...
  te: {
    translation: {
      ...
      totalInvestment: "టోటల్ పెట్టుబడి",
      totalSold: "టోటల్ అమ్మకం",
      availableMoney: "అవైలబుల్ మనీ",
      yourMoney: "మీ మనీ",
      yourInvestment: "మీ పెట్టుబడి",
      ...
      yourSoldAmount: "మీ అమ్మకం అమౌంట్ ",
      totalSoldAmount: "టోటల్ అమ్మకం అమౌంట్ ",
      ...
      sold: "అమ్మకం",
      withdraw: "విత్డ్రా",
      investmentWithdraw: "పెట్టుబడి విత్డ్రా",
      add: "యాడ్",
      consume: "కన్స్యూమ్",
      ...
      soldDetails: "అమ్మకాల డీటెయిల్స్",
      soldAmount: "అమ్మకాల అమౌంట్",
